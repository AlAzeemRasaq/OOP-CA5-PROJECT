...
INSERT INTO Player (id, name, rating, age) VALUES
                                           (1, 'Bruno Fernandes', 87.6, 27),
                                           (2, 'Kevin De Bruyne', 89.0, 30),
                                           (3, 'Mohamed Salah', 90.5, 29),
                                           (4, 'Harry Kane', 89.2, 28),
                                           (5, 'Jack Grealish', 86.7, 26),
                                           (6, 'Marcus Rashford', 86.3, 24),
                                           (7, 'Virgil van Dijk', 88.9, 30),
                                           (8, 'Ruben Dias', 87.5, 25),
                                           (9, 'Bukayo Saka', 84.2, 20),
                                           (10, 'N''Golo Kanté', 88.1, 30);
